...
public class Map {
	/**
	 * Elem-eket tárol, ezt rajzoljuk ki.
	 * A {@link #frissit()} függvény ebbe a listába rakja bele a többi listából az Elemeket.
	 * Legkésõbb kerül bele az, amit meg is kívánunk jeleníteni, "legfölül van".
	 * Így a {@link #kirajzol(JTextArea)} ezt fogja megjeleníteni.
	 */
    ...
    /**
     * Ez AI-kat tárol, ezek pozícióit, stb.
     * Rálépve vagy ha õ lép ránk meghalunk.
     */
    static ArrayList<AI> aik;
    /**
     * Ez tárolja a kincsek pozícióit.
     * Rálépve kincset szerzünk.
     */
    ...
    /**
     * Bomba, amit mi rakunk le. Horizontálisan és vertikálisan terjed
     * a "robbanás", ami elpusztítja az elsõ útjába kerülõ játékost, ai-t,
     * vagy elpusztítható falat. Sima falban "megakad".
     */
    static Elem bomba;    
    /**
     * Ennyi életünk van.
    ...
    /**
     * Ez a függvény tölti be megfelelõ sorrendben a különbözõ dolgokat, úgy mint:
     * kincsek, aik, bomba, ajtó, játékos.
     * Itt ellenõrizzük, hogy a player AI-n, kincsen, vagy ajtón áll-e.
     */    
    public void frissit(){
    	alap();
    	...
    	/**
    	 * AIk feltöltése.
    	 * Végigmegyünk az aik listán és betöltjük õket az elemek listába.
    	 * Ha az egyiken rajta van a játékos, akkor az meghalt.
    	 */
    	for(AI mostani : aik){
    	...
    	/**
    	 * Kincsek feltöltése.
    	 * Végigmegyünk a kincsek listán, betöltjük õket az elemek listába.
    	 * Ha az egyiken rajta van a játékos, azt eltávolítjuk, kincset talált.
    	 */
    ...
    /**
     * Ezen függvény felel a nehézségnek megfelelõ számú ai, elpusztítható fal és kincs betételéért, és pozícióik felvételéért.
     * Itt még csak a saját listáikba rakjuk be õket a megfelelõ pozíciókkal.
     * @param nehezseg Ez szabályozza a berakások gyakoriságát.
     */
    private void feltoltCuccal(String nehezseg){
    	...
    	/**
    	 * Elpusztítható falak berakása, véletlenszerûen az üres helyekre.
    	 * Az algoritmus kihagyja a bal-felsõ részt, hogy el lehessen indulni.
    	 * Itt rakjuk be az ajtót.
    	 */
    	for(int i = 0; i < elemek.size(); i++){
    		...
    		if(mostani.getElem().equals(" "))
    			if(rnd.nextInt(100) <= percent_Pusztithatok){
    				 ...
    				 */
    				if((voltAjto == false) & ((x > tavolsag_AjtoX)&(y > tavolsag_AjtoY))){
	 ...
	 * @param ide Erre a JTextArea-ra megy a rajz.
	 */
